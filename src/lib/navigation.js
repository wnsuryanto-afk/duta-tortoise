...
export const NAV_SECTIONS = [
  {
    ...
    items: [
      ...
      { path: "/health",            section: "health",            label: "Rekam Kesehatan",   icon: Heart,        desc: "Riwayat sakit & pengobatan" },
  ...
  },
  {
    ...
    items: [
      { path: "/sop",                  section: "sop",           label: "Checklist Harian",     icon: ClipboardCheck, desc: "Tugas hari ini" },
      ...
      { path: "/maintenance-schedule", section: "maintenance",   label: "Jadwal Pemeliharaan",  icon: Calendar,       desc: "Perawatan kandang & alat" },
      { path: "/sop-library",          section: "sop-library",   label: "Perpustakaan SOP",     icon: Library,        desc: "Dokumen prosedur" },
      { path: "/task-template",        section: "task-template", label: "Template Tugas",       icon: ListTodo,       desc: "Susun tugas harian" },
  ...
  },
  {
    ...
    items: [
      { path: "/stok-unified",     section: "stock-gudang",   label: "Inventaris & Pergerakan", icon: LayoutGrid,    desc: "Stok masuk dan keluar" },
      { path: "/harus-dibeli",     section: "harus-dibeli",   label: "Harus Dibeli",            icon: ShoppingCart,  desc: "Stok menipis atau habis" },
      { path: "/daftar-belanja",   section: "daftar-belanja", label: "Permintaan Belanja",      icon: ShoppingCart,  desc: "Usulan pembelian dari tim" },
      { path: "/dashboard-stok",   section: "warehouse",      label: "Ringkasan Stok",          icon: LayoutGrid,    desc: "Nilai & sebaran stok" },
      { path: "/warehouse",        section: "warehouse",      label: "Gudang",                  icon: Package,       desc: "Detail barang gudang" },
      ...
      { path: "/stock-prediction", section: "warehouse",      label: "Prediksi Stok",           icon: AlertTriangle, desc: "Perkiraan kehabisan" },
    ],
  },
  {
    id: "uang",
    ...
    items: [
      { path: "/finance",           section: "finance",           label: "Transaksi Keuangan", icon: TrendingUp, desc: "Pemasukan & pengeluaran" },
  ...
  },
  {
    ...
    items: [
      ...
      { path: "/catatan-saran",   section: "catatan-saran", label: "Catatan Keeper",   icon: MessageCircle, desc: "Laporan dari lapangan" },
      { path: "/salary",          section: "salary",        label: "Gaji Bulanan",     icon: Calculator,    desc: "Hitung gaji" },
      ...
      { path: "/breeder-ranking", section: "breeding",      label: "Ranking & Bonus",  icon: Trophy,        desc: "Peringkat kinerja" },
...
export const EXTRA_DESTINATIONS = [
  { path: "/payroll",            section: "payroll",   label: "Laporan Payroll",      group: "Orang" },
  { path: "/payroll-gaji",       section: "payroll-gaji", label: "Payroll & Gaji",    group: "Orang" },
  { path: "/daily-payroll",      section: "payroll",   label: "Payroll Harian",       group: "Orang" },
  ...
  { path: "/feedback",           section: "feedback",  label: "Masukan Aplikasi",     group: "Laporan" },
