...
export const NAV_ACCESS = {
  owner: [
    ...
    "approval-poin", "tugas-insidentil", "daftar-belanja", "kura-diam", "breeding-calendar", "label-telur",
  ],
  admin: [
    "dashboard", "tortoise", "breeding", "family-tree", "enclosure",
    ...
    "tugas-insidentil", "daftar-belanja", "kura-diam", "breeding-calendar", "label-telur",
  ],
  manajer: [
    "dashboard", "tortoise", "breeding", "family-tree", "enclosure",
    "health", "warehouse", "finance", "users", "sop", "sop-library",
